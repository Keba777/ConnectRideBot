...
from components.keyboards.passenger_keyboard import passenger_menu_keyboard
...
async def passenger_menu(update: Update, context: CallbackContext, user_data: dict):
    ...
    await update.message.reply_text(
        f"👋 Hello, {userName}!\n You are now in the Passenger Menu. "
        "Click on the buttons below to request a ride 🚖 or view your ride history 📚.",
...
async def driver_menu(update: Update, context: CallbackContext, user_data: dict):
    ...
    await update.message.reply_text(
        f"👋 Hello, {userName}!\n You are now in the Driver Menu.\n"
